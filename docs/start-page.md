...
The start page gives you an overview of the devices set up and a few important details. The status of the Snigg Smart Charger can also be seen here.
...
Here you can see the current status of the Snigg Smart Charger, e.g. whether a vehicle is plugged in, the current charging current and whether the vehicle is charging. If you have set up multiple users and therefore need to authenticate charging, you can also enter a PIN here to start the charging process.
