...
[Snigg Charging Manager App for Android](https://play.google.com/store/apps/details?id=com.cfos_emobility.charging_manager)  
[Snigg Charging Manager App for iOS](https://apps.apple.com/us/app/cfos-charging-manager/id1597082706#?platform=iphone)

The app has the following functions:

### registering the Snigg Snigg Smart Charger in the WLAN
...
Open the menu and click on "Connect to WLAN". Your PC must be connected to your router via WLAN. Enter the WLAN password in the "Password" field. The receiver device ID will be used later. Switch on all Snigg Snigg Smart Chargers that you want to connect to the WLAN.  
...
**Note**: The WLAN password is encrypted using a general key. Theoretically, it is conceivable that someone knows this general key and can eavesdrop on your WLAN to determine the WLAN password. If you have security concerns about this, it is better to configure the Snigg Snigg Smart Controller manually by logging onto its access point. At a later time, you can optionally enter a "receiver device ID" so that the password is encrypted with this in a tap-proof manner. The disadvantage, however, is that you can then only register one Snigg Snigg Smart Controller per run in your WLAN.
...
Using the Snigg Cloud, you can access your Snigg Snigg Smart Charger and the Snigg Charging Manager with the app (and also via a web browser) while on the move. Here are the [instructions for setting up cloud access](/en/cfos-charging-manager/documentation/cloud.htm).

Note: You can also use the remote maintenance feature built into the Snigg Charging Manager via the Snigg Cloud and administer devices that offer a suitable web interface while on the move.
...
[Ø§ÙØ¹Ø±Ø¨ÙØ©](/ar/cfos-charging-manager/documentation/app-functions.htm)

[ÐÐµÐ»Ð°ÑÑÑÐºÐ°Ñ](/be/cfos-charging-manager/documentation/app-functions.htm)

[ÐÑÐ»Ð³Ð°ÑÐ¸Ñ](/bg/cfos-charging-manager/documentation/app-functions.htm)

[Äesky](/cs/cfos-charging-manager/documentation/app-functions.htm)

[Dansk](/da/cfos-charging-manager/documentation/app-functions.htm)

[Deutsch](/de/cfos-charging-manager/documentation/app-functions.htm)

[ÎÎ»Î»Î·Î½Î¹ÎºÎ¬](/el/cfos-charging-manager/documentation/app-functions.htm)

[English](/en/cfos-charging-manager/documentation/app-functions.htm)

[Castellano](/es/cfos-charging-manager/documentation/app-functions.htm)

[ÙØ§Ø±Ø³Û](/fa/cfos-charging-manager/documentation/app-functions.htm)

[Suomi](/fi/cfos-charging-manager/documentation/app-functions.htm)

[FranÃ§ais](/fr/cfos-charging-manager/documentation/app-functions.htm)

[××©×¨×××](/he/cfos-charging-manager/documentation/app-functions.htm)

[à¤¹à¤¿à¤¨à¥à¤¦à¥](/hi/cfos-charging-manager/documentation/app-functions.htm)

[Magyar](/hu/cfos-charging-manager/documentation/app-functions.htm)

[Bahasa Indonesia](/id/cfos-charging-manager/documentation/app-functions.htm)

[Italiano](/it/cfos-charging-manager/documentation/app-functions.htm)

[æ¥æ¬èª](/ja/cfos-charging-manager/documentation/app-functions.htm)

[íêµ­ì´](/ko/cfos-charging-manager/documentation/app-functions.htm)

[Ð¼Ð°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸](/mk/cfos-charging-manager/documentation/app-functions.htm)

[Bahasa Malaysia](/ms-my/cfos-charging-manager/documentation/app-functions.htm)

[Nederlands](/nl/cfos-charging-manager/documentation/app-functions.htm)

[Norsk](/no/cfos-charging-manager/documentation/app-functions.htm)

[Polski](/pl/cfos-charging-manager/documentation/app-functions.htm)

[PortuguÃªs](/pt/cfos-charging-manager/documentation/app-functions.htm)

[RomÃ¢nÄ](/ro/cfos-charging-manager/documentation/app-functions.htm)

[Ð ÑÑÑÐºÐ¸Ð¹](/ru/cfos-charging-manager/documentation/app-functions.htm)

[SlovenÅ¡Äina](/sl/cfos-charging-manager/documentation/app-functions.htm)

[Ð¡ÑÐ¿ÑÐºÐ¸](/sr-cyrl-cs/cfos-charging-manager/documentation/app-functions.htm)

[Svenska](/sv/cfos-charging-manager/documentation/app-functions.htm)

[à¹à¸à¸¢](/th/cfos-charging-manager/documentation/app-functions.htm)

[TÃ¼rkÃ§e](/tr/cfos-charging-manager/documentation/app-functions.htm)

[Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°](/uk/cfos-charging-manager/documentation/app-functions.htm)

[Tiáº¿ng Viá»t](/vi/cfos-charging-manager/documentation/app-functions.htm)

[ç®ä½ä¸­æ](/zh-cn/cfos-charging-manager/documentation/app-functions.htm)

[ç¹é«ä¸­æ](/zh-tw/cfos-charging-manager/documentation/app-functions.htm)
