...
# Snigg Charging Manager on the Smart Meter Gateway (SMGW)

You can operate the Snigg Charging Manager on the HAN interface of a smart meter gateway. According to BSI TR-03109-1, a Smart Meter Gateway provides a transparent interface from the HAN interface via the WAN interface to the network operator or energy supplier. This is regulated in HAF3 (3.4.2.3) and must be configured accordingly by the smart meter gateway administrator (connection between EMT and CLS).

Operation on the Smart Meter Gateway requires a TLS certificate on the part of the Snigg Charging Manager, which you can upload under "Configuration" in the Charging Manager and select for the Smart Meter Gateway.
...
1. The Snigg Charging Manager uses the OCPP gateway to connect all configured EVSEs to the OCPP backend of the energy supplier via the Smart Meter Gateway. This enables the energy supplier to see the status of all EVSEs and to log charging processes and bill for the amount of energy consumed. The Snigg Snigg Smart Chargers can also communicate in this way (even without a gateway) via the Smart Meter Gateway with the OCPP backend of the energy supplier.
2. In the event of a power shortage, the energy supplier or grid operator can reduce the house connection power available to the Snigg Charging Manager.
3. The energy supplier can inform the Snigg Charging Manager of the start and end of tariffs, which can then be taken into account by the EVSEs and users by means of charging rules.
...
![Charging management on the smart meter gateway](/images/load-management-with-smart-meter-gateway.png)
...
[Ø§ÙØ¹Ø±Ø¨ÙØ©](/ar/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[ÐÐµÐ»Ð°ÑÑÑÐºÐ°Ñ](/be/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[ÐÑÐ»Ð³Ð°ÑÐ¸Ñ](/bg/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Äesky](/cs/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Dansk](/da/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Deutsch](/de/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[ÎÎ»Î»Î·Î½Î¹ÎºÎ¬](/el/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[English](/en/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Castellano](/es/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[ÙØ§Ø±Ø³Û](/fa/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Suomi](/fi/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[FranÃ§ais](/fr/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[××©×¨×××](/he/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[à¤¹à¤¿à¤¨à¥à¤¦à¥](/hi/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Magyar](/hu/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Bahasa Indonesia](/id/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Italiano](/it/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[æ¥æ¬èª](/ja/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[íêµ­ì´](/ko/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Ð¼Ð°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸](/mk/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Bahasa Malaysia](/ms-my/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Nederlands](/nl/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Norsk](/no/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Polski](/pl/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[PortuguÃªs](/pt/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[RomÃ¢nÄ](/ro/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Ð ÑÑÑÐºÐ¸Ð¹](/ru/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[SlovenÅ¡Äina](/sl/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Ð¡ÑÐ¿ÑÐºÐ¸](/sr-cyrl-cs/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Svenska](/sv/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[à¹à¸à¸¢](/th/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[TÃ¼rkÃ§e](/tr/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°](/uk/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[Tiáº¿ng Viá»t](/vi/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[ç®ä½ä¸­æ](/zh-cn/cfos-charging-manager/documentation/smart-meter-gateway.htm)

[ç¹é«ä¸­æ](/zh-tw/cfos-charging-manager/documentation/smart-meter-gateway.htm)
