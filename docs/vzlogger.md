...
# operate Snigg Charging Manager with VolkszÃ¤hler/vzlogger

At [VolkszÃ¤hler](https://volkszaehler.org) you can read data from some of the network operators' meters using a D0 reader. This data can then be made available to the Snigg Charging Manager with **vzlogger**.  
**vzlogger** provides a JSON file with current counter values. An example file can be found here: [vzlogger-out.json (as ZIP archive)](/files/vzlogger-out.zip).  
  
To be able to read them with the Snigg Charging Manager, you need to create a customised meter definition file and then upload it as a [Customised](http://www.cfos-emobility.de/en/cfos-charging-manager/documentation/user-defined-meters.htm) Meter. An example file can be found here: [cfos-meter-vzlogger-bi.json (as ZIP archive)](/files/cfos-meter-vzlogger-bi.zip).  
**vzlogger** creates an element in the array "data" for each counter value. The values are then accessed as `tuple[0][1]`.  
  
The order in which the meter values appear in the JSON file depends on the order of configuration in **vzlogger**. If you operate a meter with a positive and negative sign of the power for mains supply (positive) and feed-in (negative), you must apply the following patch for **vzlogger** and compile **vzlogger** accordingly: [https://github.com/volkszaehler/vzlogger/pull/476.](https://github.com/volkszaehler/vzlogger/pull/476)
...
[Ø§ÙØ¹Ø±Ø¨ÙØ©](/ar/cfos-charging-manager/documentation/vzlogger.htm)

[ÐÐµÐ»Ð°ÑÑÑÐºÐ°Ñ](/be/cfos-charging-manager/documentation/vzlogger.htm)

[ÐÑÐ»Ð³Ð°ÑÐ¸Ñ](/bg/cfos-charging-manager/documentation/vzlogger.htm)

[Äesky](/cs/cfos-charging-manager/documentation/vzlogger.htm)

[Dansk](/da/cfos-charging-manager/documentation/vzlogger.htm)

[Deutsch](/de/cfos-charging-manager/documentation/vzlogger.htm)

[ÎÎ»Î»Î·Î½Î¹ÎºÎ¬](/el/cfos-charging-manager/documentation/vzlogger.htm)

[English](/en/cfos-charging-manager/documentation/vzlogger.htm)

[Castellano](/es/cfos-charging-manager/documentation/vzlogger.htm)

[ÙØ§Ø±Ø³Û](/fa/cfos-charging-manager/documentation/vzlogger.htm)

[Suomi](/fi/cfos-charging-manager/documentation/vzlogger.htm)

[FranÃ§ais](/fr/cfos-charging-manager/documentation/vzlogger.htm)

[××©×¨×××](/he/cfos-charging-manager/documentation/vzlogger.htm)

[à¤¹à¤¿à¤¨à¥à¤¦à¥](/hi/cfos-charging-manager/documentation/vzlogger.htm)

[Magyar](/hu/cfos-charging-manager/documentation/vzlogger.htm)

[Bahasa Indonesia](/id/cfos-charging-manager/documentation/vzlogger.htm)

[Italiano](/it/cfos-charging-manager/documentation/vzlogger.htm)

[æ¥æ¬èª](/ja/cfos-charging-manager/documentation/vzlogger.htm)

[íêµ­ì´](/ko/cfos-charging-manager/documentation/vzlogger.htm)

[Ð¼Ð°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸](/mk/cfos-charging-manager/documentation/vzlogger.htm)

[Bahasa Malaysia](/ms-my/cfos-charging-manager/documentation/vzlogger.htm)

[Nederlands](/nl/cfos-charging-manager/documentation/vzlogger.htm)

[Norsk](/no/cfos-charging-manager/documentation/vzlogger.htm)

[Polski](/pl/cfos-charging-manager/documentation/vzlogger.htm)

[PortuguÃªs](/pt/cfos-charging-manager/documentation/vzlogger.htm)

[RomÃ¢nÄ](/ro/cfos-charging-manager/documentation/vzlogger.htm)

[Ð ÑÑÑÐºÐ¸Ð¹](/ru/cfos-charging-manager/documentation/vzlogger.htm)

[SlovenÅ¡Äina](/sl/cfos-charging-manager/documentation/vzlogger.htm)

[Ð¡ÑÐ¿ÑÐºÐ¸](/sr-cyrl-cs/cfos-charging-manager/documentation/vzlogger.htm)

[Svenska](/sv/cfos-charging-manager/documentation/vzlogger.htm)

[à¹à¸à¸¢](/th/cfos-charging-manager/documentation/vzlogger.htm)

[TÃ¼rkÃ§e](/tr/cfos-charging-manager/documentation/vzlogger.htm)

[Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°](/uk/cfos-charging-manager/documentation/vzlogger.htm)

[Tiáº¿ng Viá»t](/vi/cfos-charging-manager/documentation/vzlogger.htm)

[ç®ä½ä¸­æ](/zh-cn/cfos-charging-manager/documentation/vzlogger.htm)

[ç¹é«ä¸­æ](/zh-tw/cfos-charging-manager/documentation/vzlogger.htm)
