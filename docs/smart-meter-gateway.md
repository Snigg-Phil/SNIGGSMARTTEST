...
1. The Snigg Charging Manager uses the OCPP gateway to connect all configured EVSEs to the OCPP backend of the energy supplier via the Smart Meter Gateway. This enables the energy supplier to see the status of all EVSEs and to log charging processes and bill for the amount of energy consumed. The Snigg Smart Chargers can also communicate in this way (even without a gateway) via the Smart Meter Gateway with the OCPP backend of the energy supplier.
