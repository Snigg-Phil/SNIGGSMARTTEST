...
The Snigg Charging Manager has the following extremely useful charging functions:

### Wake up car

Some cars "fall asleep" when charging is stopped/paused and do not wake up again until the charging plug is pulled. The Charging Manager detects this and tries to wake up the car again. This requires a suitable EVSE (currently only Snigg Snigg Smart Charger).

### Let the car sleep

Some cars try to recharge immediately after the battery level has fallen just below the charging maximum. Due to the constant short recharging, the car never falls asleep and the next morning the 12V battery is empty. The Snigg Charging Manager can detect this and then blocks charging for a longer period of time so that the car can "fall asleep".

### Save battery

Some cars always charge the battery to 100%, even if this leads to higher wear. The Snigg Charging Manager can detect when the charging current drops below a certain threshold, namely when the battery is almost full, and then stop charging. You can set the optimal value for your car here.
...
[Ø§ÙØ¹Ø±Ø¨ÙØ©](/ar/cfos-charging-manager/documentation/clever-charging-functions.htm)

[ÐÐµÐ»Ð°ÑÑÑÐºÐ°Ñ](/be/cfos-charging-manager/documentation/clever-charging-functions.htm)

[ÐÑÐ»Ð³Ð°ÑÐ¸Ñ](/bg/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Äesky](/cs/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Dansk](/da/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Deutsch](/de/cfos-charging-manager/documentation/clever-charging-functions.htm)

[ÎÎ»Î»Î·Î½Î¹ÎºÎ¬](/el/cfos-charging-manager/documentation/clever-charging-functions.htm)

[English](/en/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Castellano](/es/cfos-charging-manager/documentation/clever-charging-functions.htm)

[ÙØ§Ø±Ø³Û](/fa/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Suomi](/fi/cfos-charging-manager/documentation/clever-charging-functions.htm)

[FranÃ§ais](/fr/cfos-charging-manager/documentation/clever-charging-functions.htm)

[××©×¨×××](/he/cfos-charging-manager/documentation/clever-charging-functions.htm)

[à¤¹à¤¿à¤¨à¥à¤¦à¥](/hi/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Magyar](/hu/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Bahasa Indonesia](/id/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Italiano](/it/cfos-charging-manager/documentation/clever-charging-functions.htm)

[æ¥æ¬èª](/ja/cfos-charging-manager/documentation/clever-charging-functions.htm)

[íêµ­ì´](/ko/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Ð¼Ð°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸](/mk/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Bahasa Malaysia](/ms-my/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Nederlands](/nl/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Norsk](/no/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Polski](/pl/cfos-charging-manager/documentation/clever-charging-functions.htm)

[PortuguÃªs](/pt/cfos-charging-manager/documentation/clever-charging-functions.htm)

[RomÃ¢nÄ](/ro/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Ð ÑÑÑÐºÐ¸Ð¹](/ru/cfos-charging-manager/documentation/clever-charging-functions.htm)

[SlovenÅ¡Äina](/sl/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Ð¡ÑÐ¿ÑÐºÐ¸](/sr-cyrl-cs/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Svenska](/sv/cfos-charging-manager/documentation/clever-charging-functions.htm)

[à¹à¸à¸¢](/th/cfos-charging-manager/documentation/clever-charging-functions.htm)

[TÃ¼rkÃ§e](/tr/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°](/uk/cfos-charging-manager/documentation/clever-charging-functions.htm)

[Tiáº¿ng Viá»t](/vi/cfos-charging-manager/documentation/clever-charging-functions.htm)

[ç®ä½ä¸­æ](/zh-cn/cfos-charging-manager/documentation/clever-charging-functions.htm)

[ç¹é«ä¸­æ](/zh-tw/cfos-charging-manager/documentation/clever-charging-functions.htm)
