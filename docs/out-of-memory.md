...
# Remedy memory shortage in the Snigg Snigg Smart Controller

If the Snigg Snigg Smart Controller runs out of memory, a corresponding message appears after a restart. You should then try to reduce the memory requirement. Here are some tips, most important first:

* deactivate Snigg Mesh. The Snigg Mesh requires a relatively large amount of memory. If you only use one wallbox, you should deactivate it. Please only use the Mesh if a Snigg Snigg Smart Charger is to be connected to the domestic WLAN via another wallbox.
* Reduce TLS / SSL / https connections. You should only access the Snigg Snigg Smart Controller from the home network using http. We recommend using https for external connections.
* Access from multiple browsers simultaneously. Modern web browsers establish several connections at the same time if possible. This places a considerable load on the ESP in the Snigg Snigg Smart Controller. Limit the number of simultaneous accesses to the wallbox's web interface.
...
[Ø§ÙØ¹Ø±Ø¨ÙØ©](/ar/cfos-charging-manager/documentation/out-of-memory.htm)

[ÐÐµÐ»Ð°ÑÑÑÐºÐ°Ñ](/be/cfos-charging-manager/documentation/out-of-memory.htm)

[ÐÑÐ»Ð³Ð°ÑÐ¸Ñ](/bg/cfos-charging-manager/documentation/out-of-memory.htm)

[Äesky](/cs/cfos-charging-manager/documentation/out-of-memory.htm)

[Dansk](/da/cfos-charging-manager/documentation/out-of-memory.htm)

[Deutsch](/de/cfos-charging-manager/documentation/out-of-memory.htm)

[ÎÎ»Î»Î·Î½Î¹ÎºÎ¬](/el/cfos-charging-manager/documentation/out-of-memory.htm)

[English](/en/cfos-charging-manager/documentation/out-of-memory.htm)

[Castellano](/es/cfos-charging-manager/documentation/out-of-memory.htm)

[ÙØ§Ø±Ø³Û](/fa/cfos-charging-manager/documentation/out-of-memory.htm)

[Suomi](/fi/cfos-charging-manager/documentation/out-of-memory.htm)

[FranÃ§ais](/fr/cfos-charging-manager/documentation/out-of-memory.htm)

[××©×¨×××](/he/cfos-charging-manager/documentation/out-of-memory.htm)

[à¤¹à¤¿à¤¨à¥à¤¦à¥](/hi/cfos-charging-manager/documentation/out-of-memory.htm)

[Magyar](/hu/cfos-charging-manager/documentation/out-of-memory.htm)

[Bahasa Indonesia](/id/cfos-charging-manager/documentation/out-of-memory.htm)

[Italiano](/it/cfos-charging-manager/documentation/out-of-memory.htm)

[æ¥æ¬èª](/ja/cfos-charging-manager/documentation/out-of-memory.htm)

[íêµ­ì´](/ko/cfos-charging-manager/documentation/out-of-memory.htm)

[Ð¼Ð°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸](/mk/cfos-charging-manager/documentation/out-of-memory.htm)

[Bahasa Malaysia](/ms-my/cfos-charging-manager/documentation/out-of-memory.htm)

[Nederlands](/nl/cfos-charging-manager/documentation/out-of-memory.htm)

[Norsk](/no/cfos-charging-manager/documentation/out-of-memory.htm)

[Polski](/pl/cfos-charging-manager/documentation/out-of-memory.htm)

[PortuguÃªs](/pt/cfos-charging-manager/documentation/out-of-memory.htm)

[RomÃ¢nÄ](/ro/cfos-charging-manager/documentation/out-of-memory.htm)

[Ð ÑÑÑÐºÐ¸Ð¹](/ru/cfos-charging-manager/documentation/out-of-memory.htm)

[SlovenÅ¡Äina](/sl/cfos-charging-manager/documentation/out-of-memory.htm)

[Ð¡ÑÐ¿ÑÐºÐ¸](/sr-cyrl-cs/cfos-charging-manager/documentation/out-of-memory.htm)

[Svenska](/sv/cfos-charging-manager/documentation/out-of-memory.htm)

[à¹à¸à¸¢](/th/cfos-charging-manager/documentation/out-of-memory.htm)

[TÃ¼rkÃ§e](/tr/cfos-charging-manager/documentation/out-of-memory.htm)

[Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°](/uk/cfos-charging-manager/documentation/out-of-memory.htm)

[Tiáº¿ng Viá»t](/vi/cfos-charging-manager/documentation/out-of-memory.htm)

[ç®ä½ä¸­æ](/zh-cn/cfos-charging-manager/documentation/out-of-memory.htm)

[ç¹é«ä¸­æ](/zh-tw/cfos-charging-manager/documentation/out-of-memory.htm)
