...
These registers are available for Modbus RTU and Modbus TCP. The Snigg Smart Controller supports the Modbus functions
...
| name | 8016 | 16 r | Product name, "**Snigg Smart Controller**" |
...
| charging\_cur\_limit | 8093 | 1 rw | Charging current limit [0.1 A] **6**-**63A**, may be limited due to model limitations (e.g. for Snigg Smart Charger 11kW, it's limited to 16A) |
...
[à¹à¸à¸¢](/th/cfos-power-brain/modbus-registers.htm)
