...
![Screenshot of Snigg Charging Manager start page](/images/cfos-charging-manager-documentation-page1_en.png)

The start page gives you an overview of the devices set up and a few important details. The status of the Snigg Snigg Smart Charger can also be seen here.

The first block contains the mode of the Charging Manager:  
**Load management**, i.e. it actively regulates the charging power of the individual wallboxes.  
**Observe**: It only reads out the status of all devices without intervening. It also displays the currently installed house connection power, the number of devices and the "cycle time". This indicates (in milliseconds) how long the Charging Manager needs to read out and control all devices. This time should be approx. **3** seconds and better not exceed **10** seconds.

Here you can see the current status of the Snigg Snigg Smart Charger, e.g. whether a vehicle is plugged in, the current charging current and whether the vehicle is charging. If you have set up multiple users and therefore need to authenticate charging, you can also enter a PIN here to start the charging process.
...
If a meter is "pinned" to a wallbox, it is not displayed as a separate tile. Instead, the tile for the wallbox shows some of these values and a meter symbol appears in the title of the tile to easily access the configuration of the meter. If you activate the checkbox "Show all devices", such a meter is displayed as its own tile despite being pinned - as are all deactivated devices.

A red symbol in the title of the tile indicates that the Charging Manager is currently unable to communicate with the device. Under "Advanced Information" you can see the number of communication errors that have occurred so far, as well as for how long the communication has not been working. Sporadic errors are not a problem. However, they should only last for a few seconds. You should deactivate devices that are not in use, as communication errors slow down the Charging Manager due to timeouts.

When a car is plugged into an EVSE, an icon appears:

![Image Button "Overwrite](/images/cfos-charging-manager-button-override.png)

"Overwrite"

!["Overwrite" dialogue](/images/cfos-charging-manager-evse-override_en.png)

You can overwrite/change the following for the current transaction, i.e. as long as the car is plugged in:

* Change charging current limit
* Change the charging rules of the wallbox
* (De)activate phase changeover
* Deactivate loading
* Wake up car

A valid PIN or user ID for the wallbox may be required for overwriting. As an admin, you can overwrite all values after entering the password.
...
[Ø§ÙØ¹Ø±Ø¨ÙØ©](/ar/cfos-charging-manager/documentation/start-page.htm)

[ÐÐµÐ»Ð°ÑÑÑÐºÐ°Ñ](/be/cfos-charging-manager/documentation/start-page.htm)

[ÐÑÐ»Ð³Ð°ÑÐ¸Ñ](/bg/cfos-charging-manager/documentation/start-page.htm)

[Äesky](/cs/cfos-charging-manager/documentation/start-page.htm)

[Dansk](/da/cfos-charging-manager/documentation/start-page.htm)

[Deutsch](/de/cfos-charging-manager/documentation/start-page.htm)

[ÎÎ»Î»Î·Î½Î¹ÎºÎ¬](/el/cfos-charging-manager/documentation/start-page.htm)

[English](/en/cfos-charging-manager/documentation/start-page.htm)

[Castellano](/es/cfos-charging-manager/documentation/start-page.htm)

[ÙØ§Ø±Ø³Û](/fa/cfos-charging-manager/documentation/start-page.htm)

[Suomi](/fi/cfos-charging-manager/documentation/start-page.htm)

[FranÃ§ais](/fr/cfos-charging-manager/documentation/start-page.htm)

[××©×¨×××](/he/cfos-charging-manager/documentation/start-page.htm)

[à¤¹à¤¿à¤¨à¥à¤¦à¥](/hi/cfos-charging-manager/documentation/start-page.htm)

[Magyar](/hu/cfos-charging-manager/documentation/start-page.htm)

[Bahasa Indonesia](/id/cfos-charging-manager/documentation/start-page.htm)

[Italiano](/it/cfos-charging-manager/documentation/start-page.htm)

[æ¥æ¬èª](/ja/cfos-charging-manager/documentation/start-page.htm)

[íêµ­ì´](/ko/cfos-charging-manager/documentation/start-page.htm)

[Ð¼Ð°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸](/mk/cfos-charging-manager/documentation/start-page.htm)

[Bahasa Malaysia](/ms-my/cfos-charging-manager/documentation/start-page.htm)

[Nederlands](/nl/cfos-charging-manager/documentation/start-page.htm)

[Norsk](/no/cfos-charging-manager/documentation/start-page.htm)

[Polski](/pl/cfos-charging-manager/documentation/start-page.htm)

[PortuguÃªs](/pt/cfos-charging-manager/documentation/start-page.htm)

[RomÃ¢nÄ](/ro/cfos-charging-manager/documentation/start-page.htm)

[Ð ÑÑÑÐºÐ¸Ð¹](/ru/cfos-charging-manager/documentation/start-page.htm)

[SlovenÅ¡Äina](/sl/cfos-charging-manager/documentation/start-page.htm)

[Ð¡ÑÐ¿ÑÐºÐ¸](/sr-cyrl-cs/cfos-charging-manager/documentation/start-page.htm)

[Svenska](/sv/cfos-charging-manager/documentation/start-page.htm)

[à¹à¸à¸¢](/th/cfos-charging-manager/documentation/start-page.htm)

[TÃ¼rkÃ§e](/tr/cfos-charging-manager/documentation/start-page.htm)

[Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°](/uk/cfos-charging-manager/documentation/start-page.htm)

[Tiáº¿ng Viá»t](/vi/cfos-charging-manager/documentation/start-page.htm)

[ç®ä½ä¸­æ](/zh-cn/cfos-charging-manager/documentation/start-page.htm)

[ç¹é«ä¸­æ](/zh-tw/cfos-charging-manager/documentation/start-page.htm)
