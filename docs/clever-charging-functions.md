...
Some cars "fall asleep" when charging is stopped/paused and do not wake up again until the charging plug is pulled. The Charging Manager detects this and tries to wake up the car again. This requires a suitable EVSE (currently only Snigg Smart Charger).
