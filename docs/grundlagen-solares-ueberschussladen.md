...
This requires at least one Snigg Smart Charger and a meter that can measure the power fed into or drawn from the grid, as well as a PV system, of course. If you already have a wallbox from another manufacturer, you can use our Charging Manager Kit to realise PV surplus charging.
...
#### [More information on surplus charging with the Snigg Charging Manager](/en/cfos-charging-manager/documentation/surplus-charging.htm)
...
[ÎÎ»Î»Î·Î½Î¹ÎºÎ¬](/el/cfos-charging-manager/documentation/grundlagen-solares-ueberschussladen.htm)
