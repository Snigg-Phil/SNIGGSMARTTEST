...
Then you can see if the Snigg Charging Manager is compatible with your inverter.
...
**Note**: The EVSEs or meters have been tested with the software version of the respective manufacturer specified in the tables. We do not guarantee that the manufacturer will change the functionality through a software update or model update in such a way that the interoperability with the Snigg Charging Manager or Snigg Snigg Smart Charger is no longer given. You can ask the respective manufacturer whether the functionality still corresponds to the status indicated in our table.

Alternatively, you can [download](/en/cfos-charging-manager/download.htm) the [free test version of the Snigg Charging Manager for Windows or Raspberry Pi](/en/cfos-charging-manager/download.htm) and test for yourself whether the respective device is compatible.
...
[Ø§ÙØ¹Ø±Ø¨ÙØ©](/ar/cfos-charging-manager/documentation/meter-test.htm)
...
[Tiáº¿ng Viá»t](/vi/cfos-charging-manager/documentation/meter-test.htm)
