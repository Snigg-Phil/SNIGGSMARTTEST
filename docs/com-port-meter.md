...
COM port counter for Snigg Charging Manager under Raspberry and Windows
======================================================================

S0 meters have a switching output for the S0 pulses (e.g. 1000 pulses per kWh). The Snigg Charging Manager can evaluate these pulses at an RS232 interface and make them available in the form of a "COM port" counter. In this way, a counter can be connected to a Raspberry or PC with little effort. A USB RSR adapter and suitable terminals are required:  
[RS232 USB Adapter](https://www.reichelt.de/usb-2-0-konverter-a-stecker-auf-rs232-logilink-au0002f-p331129.html?&trstct=pos_2&nbc=1)  
[Klemmen fÃ¼r RS232](https://www.reichelt.de/sub-d-9-pin-buchse-terminalblock-10-pin-delock-65268-p113237.html?&trstct=pos_9&nbc=1)

The S0 output of the counter must switch the RX pin to ground from the RS232 interface. Please note that most S0 counters use transistor outputs and the current can only flow in one direction. Therefore, please rotate the wire pair if necessary. You can then set up a "COM Port" counter in the Snigg Charging Manager. Enter the COM port provided by the USB adapter as the address. Then you have to set the pulses per kWh that your meter supplies.  
...
[Ø§ÙØ¹Ø±Ø¨ÙØ©](/ar/cfos-charging-manager/documentation/com-port-meter.htm)

[ÐÐµÐ»Ð°ÑÑÑÐºÐ°Ñ](/be/cfos-charging-manager/documentation/com-port-meter.htm)

[ÐÑÐ»Ð³Ð°ÑÐ¸Ñ](/bg/cfos-charging-manager/documentation/com-port-meter.htm)

[Äesky](/cs/cfos-charging-manager/documentation/com-port-meter.htm)

[Dansk](/da/cfos-charging-manager/documentation/com-port-meter.htm)

[Deutsch](/de/cfos-charging-manager/documentation/com-port-meter.htm)

[ÎÎ»Î»Î·Î½Î¹ÎºÎ¬](/el/cfos-charging-manager/documentation/com-port-meter.htm)

[English](/en/cfos-charging-manager/documentation/com-port-meter.htm)

[Castellano](/es/cfos-charging-manager/documentation/com-port-meter.htm)

[ÙØ§Ø±Ø³Û](/fa/cfos-charging-manager/documentation/com-port-meter.htm)

[Suomi](/fi/cfos-charging-manager/documentation/com-port-meter.htm)

[FranÃ§ais](/fr/cfos-charging-manager/documentation/com-port-meter.htm)

[××©×¨×××](/he/cfos-charging-manager/documentation/com-port-meter.htm)

[à¤¹à¤¿à¤¨à¥à¤¦à¥](/hi/cfos-charging-manager/documentation/com-port-meter.htm)

[Magyar](/hu/cfos-charging-manager/documentation/com-port-meter.htm)

[Bahasa Indonesia](/id/cfos-charging-manager/documentation/com-port-meter.htm)

[Italiano](/it/cfos-charging-manager/documentation/com-port-meter.htm)

[æ¥æ¬èª](/ja/cfos-charging-manager/documentation/com-port-meter.htm)

[íêµ­ì´](/ko/cfos-charging-manager/documentation/com-port-meter.htm)

[Ð¼Ð°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸](/mk/cfos-charging-manager/documentation/com-port-meter.htm)

[Bahasa Malaysia](/ms-my/cfos-charging-manager/documentation/com-port-meter.htm)

[Nederlands](/nl/cfos-charging-manager/documentation/com-port-meter.htm)

[Norsk](/no/cfos-charging-manager/documentation/com-port-meter.htm)

[Polski](/pl/cfos-charging-manager/documentation/com-port-meter.htm)

[PortuguÃªs](/pt/cfos-charging-manager/documentation/com-port-meter.htm)

[RomÃ¢nÄ](/ro/cfos-charging-manager/documentation/com-port-meter.htm)

[Ð ÑÑÑÐºÐ¸Ð¹](/ru/cfos-charging-manager/documentation/com-port-meter.htm)

[SlovenÅ¡Äina](/sl/cfos-charging-manager/documentation/com-port-meter.htm)

[Ð¡ÑÐ¿ÑÐºÐ¸](/sr-cyrl-cs/cfos-charging-manager/documentation/com-port-meter.htm)

[Svenska](/sv/cfos-charging-manager/documentation/com-port-meter.htm)

[à¹à¸à¸¢](/th/cfos-charging-manager/documentation/com-port-meter.htm)

[TÃ¼rkÃ§e](/tr/cfos-charging-manager/documentation/com-port-meter.htm)

[Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°](/uk/cfos-charging-manager/documentation/com-port-meter.htm)

[Tiáº¿ng Viá»t](/vi/cfos-charging-manager/documentation/com-port-meter.htm)

[ç®ä½ä¸­æ](/zh-cn/cfos-charging-manager/documentation/com-port-meter.htm)

[ç¹é«ä¸­æ](/zh-tw/cfos-charging-manager/documentation/com-port-meter.htm)
