...
To be able to read them with the Snigg Charging Manager, you need to create a customised meter definition file and then upload it as a [Customised](http://www.snigg.be/en/cfos-charging-manager/documentation/user-defined-meters.htm) Meter. An example file can be found here: [cfos-meter-vzlogger-bi.json (as ZIP archive)](/files/cfos-meter-vzlogger-bi.zip).  
